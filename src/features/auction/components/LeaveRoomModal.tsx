    ...
    >
      ...
      >
        ...
        <div className="px-4 pb-4 flex flex-col gap-2">
          <button
            onClick={onConfirm}
            className="w-full py-2.5 bg-red-500 hover:bg-red-600 text-primary-foreground rounded-md font-bold transition-colors flex items-center justify-center gap-2 text-sm shadow-sm"
          >
