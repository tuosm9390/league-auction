      ...
      >
        ...
        <div className="px-4 py-3 border-b border-border flex items-center justify-between bg-muted/50 rounded-t-xl">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-secondary rounded-lg flex items-center justify-center border border-border text-secondary-foreground">
              <LogOut size={16} />
            </div>
            <div>
        ...
        <div className="px-4 pb-4 flex flex-col gap-2">
          <button
            onClick={onConfirm}
            className="w-full py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-md font-bold transition-colors flex items-center justify-center gap-2 text-sm shadow-sm"
          >
            <LogOut size={14} />방 나가기
          </button>
          <button
            onClick={onClose}
            className="w-full py-2.5 text-xs font-bold text-muted-foreground hover:text-foreground hover:bg-muted rounded-md transition-colors border border-transparent"
          >
            취소
          </button>
        </div>
