  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 bg-secondary hover:bg-secondary/80 text-secondary-foreground px-3.5 py-1.5 rounded-lg text-xs font-bold transition-colors border border-border shadow-sm"
      >
        <Link size={14} /> 링크 확인
      </button>
