    ...
    <div className=\"min-h-screen bg-background relative overflow-hidden transition-colors duration-500\">
      ...
      <div className=\"relative z-10 flex flex-col items-center px-4 py-16 gap-8\">
        ...
        <div className=\"max-w-7xl w-full animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150\">
          <h2 className=\"text-2xl font-black text-secondary text-center mb-8\">
            이용 방법
          </h2>
            ...
            {HOW_TO_USE.map((item) => (
              ...
              >
                <div className=\"flex items-center gap-3 mb-3\">
                  ...
                  <span className=\"text-xs font-black text-secondary bg-primary/30 px-2 py-0.5 rounded-full\">
                    STEP {item.step}
                  </span>
                </div>
