...
AI 행동 지침 (Lessons Learned & New Rules): 이 경험을 바탕으로, 앞으로 네가 코드를 작성할 때 절대 하지 말아야 할 행동과 반드시 지켜야 할 새로운 규칙을 1~2문장으로 추출해 줘. 이 규칙은 우리의 프로젝트 RULES.md에 추가할 수 일 만큼 명확하고 단호해야 해."
```
